...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
    cube_result = volume_of_cube(7)
    assert_equal(343, cube_result)
    #add test code here
  end
  ...
  def test_volume_of_sphere()
    ...
    assert_equal(523.3333333333334, sphere_result)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    #add test code here
    celsius_result = fahrenheit_to_celsius(16)
    assert_equal(-8.89, celsius_result)
  end
